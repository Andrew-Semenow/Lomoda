...
const cartOvarlay = document.querySelector(".cart-overlay");
...
const cartModalOpen = () => {
  cartOvarlay.classList.add("cart-overlay-open");
  disableScroll();
  renderCart();
};

const cartModalClose = () => {
  cartOvarlay.classList.remove("cart-overlay-open");
  enableScroll();
};
...
try {
  ...
  window.addEventListener("hashchange", () => {
    ...
    getGoods(rednerGoodsList, "category", hash);
    changeTitle();
  });
